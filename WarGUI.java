...
public class WarGUI extends JFrame
{
   ...
   /** JLabel */
   private JLabel status,warStatus;
   ...
   */
   ...
   public WarGUI()
   {
      ...
      //add a label to the north region displaying directions and status of game
      panel4 = new JPanel();
      ...
      panel5 = new JPanel(); //this panel will will hold a label for when a war occurs 
   ...
   class ButtonListener implements ActionListener
   {
      ...
      public void actionPerformed(ActionEvent e)
      {
         ...
         {
            //clear center panels because no war occured
            warStatus.setText("");
            panel6.removeAll();
            ...
            //set the images to the next cards on top of each pile
            cardPic = pile1.get(0).getImageIcon();
            cardPic2 = pile2.get(0).getImageIcon();
